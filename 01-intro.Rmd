...
![Installer un package sous CRAN ou à partir d'une archive!](docs/R-bookdown_files/figure-html/install_packages2.png)
...
![Charger un package comme dplyr!](docs/R-bookdown_files/figure-html/load_packages.png)
